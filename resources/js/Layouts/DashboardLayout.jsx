...
const navigation = [
  { name: 'Dashboard', href: '/dashboard', icon: HomeIcon, current: false, role_id: [1,2,3,4] },
...
//   { name: 'Roles', href: '/roles', icon: UsersIcon, current: false, role_id: 2 },
  { name: 'Roles', href: '/roles', icon: UsersIcon, current: false, role_id: 1 },
  { name: 'Permissions', href: '/permissions', icon: UsersIcon, current: false, role_id: 1 },
  { name: 'Users', href: '/users', icon: UsersIcon, current: false, role_id: 1 },
]


const userNavigation = [
  { name: 'Ubah Profil', href: route('profile.edit'), role_id: 1 },
  { name: 'Ubah Profil', href: route('profile.edit'), role_id: 2 },
  { name: 'Ubah Profil', href: route('profil-sekolah'), role_id: 3 },
  { name: 'Ubah Profil', href: route('profil-guru'), role_id: 4 },
  { name: 'Ubah Profil', href: route('profil-siswa'), role_id: 5 },
  { name: 'Ubah Profil', href: route('profil-kepala-sekolah'), role_id: 6 },
...
const DashboardLayout = ({user, header, children}) => {
  ...
  return (
    ...
    <div>
        ...
        {/* <MobileMenu show={sidebarOpen} as={Fragment} /> */}
        <DesktopMenu user={user} navigation={navigation} />
                  ...
                  >
                    <Menu.Items className="absolute right-0 z-10 mt-2.5 w-32 origin-top-right rounded-md bg-white py-2 shadow-lg ring-1 ring-gray-900/5 focus:outline-none">
                      {userNavigation.map((item) => (
                        ...
                        <LogOutLink method="post" href={route('logout')} as="button">
                            Sign out
                        </LogOutLink>
