...
export default function Index({ auth, props, semester, id_semester, jenis_semester, kelompok_usia, kelompok, filtering, dimensi, bulan_awal, bulan_akhir, role_id }) {
    ...
    filtering = filtering || {};
        ...
        router.get('/laporan-bulanan', filtering);
    };
    ...
    const databulan = [
        {id: "7", nama: "Juli", semester: "1"}, 
        {id: "8", nama: "Agustus", semester: "1"},
        {id: "9", nama: "September", semester: "1"},
        {id: "10", nama: "Oktober", semester: "1"},
        {id: "11", nama: "November", semester: "1"},
        {id: "12", nama: "Desember", semester: "1"},
    ...
    return (
        <DashboardLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Laporan Bulanan</h2>}
        >
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 bg-white border-b border-gray-200">
                            ...
                            <h1 className="text-2xl mb-5">Laporan Bulanan</h1>
                            ...
                            <div className="-mx-2 md:items-center md:flex mb-5">
                                ...
                                <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/4 xl:w-1/4 px-2">
                                    <label className="font-bold text-sm">Bulan Awal</label>
                                    <select name="bulan_awal" 
                                    defaultValue={bulan_awal} 
                                    className="w-full px-4 py-2 text-sm" onChange={(e) =>
                                        doFilterData("bulan_awal", e.target.value)
                                    }>
                                ...
                                <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/4 xl:w-1/4 px-2">
                                    <label className="font-bold text-sm">Bulan Akhir</label>
                                    <select name="bulan_akhir" 
                                    defaultValue={bulan_akhir} 
                                    className="w-full px-4 py-2 text-sm" onChange={(e) =>
                                        doFilterData("bulan_akhir", e.target.value)
                                    }>
                                            ...
                                            <tr>
                                                ...
                                                <td className="border px-4 py-2 text-sm">
                                                    <a
                                                        ...
                                                        href={route("lihat-laporan-bulanan", dt1.id_kelompok_siswa+"-"+id_semester+"-"+bulan_awal+"-"+bulan_akhir)}
