...
export default function Index({ auth, props, searching, filtering, id_provinsi, id_kota, id_kode_wilayah }) {
    ...
    const verifiedData = (id_user) => {
        ...
        Swal.fire({
            ...
            if (result.value) {
                router.get(`/sekolah/verifikasi/${id_user}`);
                setTimeout(() => {
                    Swal.fire(
                        'Diverifikasi!',
    ...
    filtering = filtering || {};
        ...
        router.get('/verval-sekolah', filtering);
    };
    ...
    return (
        <DashboardLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Verifikasi Validasi</h2>}
        >
            <Head title="Verifikasi Validasi" />
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 bg-white border-b border-gray-200">
                            ...
                            <h1 className="text-2xl mb-5">Verifikasi dan Validasi Sekolah</h1>
                        ...
                        <Dialog as="div" className="relative z-10" tabIndex="99999" onClose={setOpen}>
                                ...
                                <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                                    ...
                                    <table className="table-auto w-full mt-2">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td className="text-right text-sm w-56"><b>Nama Sekolah</b></td>
                                                <td className="px-4 text-sm">{sk.nama}</td>
                                            </tr>
                                            <tr>
                                                <td className="text-right text-sm"><b>Status Sekolah</b></td>
                                                <td className="px-4 text-sm">{ (sk.status_sekolah == 1) ? "Negeri" : "Swasta" }</td>
                                            </tr>
                                            <tr>
                                                <td className="text-right text-sm"><b>NPSN</b></td>
                                                <td className="px-4 text-sm">{sk.npsn}</td>
                                            </tr>
                                            <tr>
                            ...
                            <div className="overflow-auto">
                                <table className="table-auto w-full">
                                    ...
                                    <tbody>
                                        {sekolah.data.map(({ id, nama, status_sekolah, npsn, sk_pendirian_sekolah, provinsi, kotakab, kecamatan, email, no_telpon, status, verified, id_user, foto, tanggal_registrasi }) => (
                                            <tr>
