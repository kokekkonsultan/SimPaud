...
export default function Edit({ auth, props }) {
    ...
    const { kepala_sekolah } = usePage().props;
    ...
    function handleSubmit(e) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                router.post(`/profil-kepala-sekolah`, {
                    nama: editNama,
                    email: editEmail,
                    id_user: editIDUser,
    ...
    return (
        <DashboardLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Profil Kepala Sekolah</h2>}
        >
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 bg-white border-b border-gray-200">
                            ...
                            <h1 className="text-2xl mb-5">Profil Kepala Sekolah</h1>
