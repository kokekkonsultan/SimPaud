...
export default function Edit({ auth, props, permission, role_permissions }) {
    ...
    function handleSubmit(e) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                put(route("roles.update", roles.id));
            }
        });
    }
    ...
    return (
        <DashboardLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Edit Roles</h2>}
        >
            <Head title="Roles" />
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 bg-white border-b border-gray-200">
                            ...
                            <h1 className="text-2xl mb-5">Edit Roles</h1>
                            ...
                            <form name="createForm" onSubmit={handleSubmit}>
                                <div className="flex flex-col">
                                    ...
                                    <div className="mb-0">
                                        ...
                                        {permission.map(({ id, name, ceked }) => (
                                        <div className="">
                                            <input type="checkbox" 
                                            name="permission[]" 
                                            id={`permission${id}`}
                                            value={id}
                                            defaultChecked={ (ceked == 1) ? true : false }
