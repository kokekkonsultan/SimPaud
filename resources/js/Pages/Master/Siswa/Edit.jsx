...
export default function Edit({ auth, props, tahun_ajaran, agama, jenis_keluar }) {
    ...
    return (
        <DashboardLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Edit Siswa</h2>}
        >
            <Head title="Siswa" />
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 bg-white border-b border-gray-200">
                            ...
                            <h1 className="text-2xl mb-5">Edit Data Peserta Didik</h1>
                                ...
                                <div className="flex flex-col">
                                    <div className="mb-4">
                                        ...
                                        <select name="id_tahun_ajaran" required className="w-full px-4 py-2" onChange={(e) =>
                                                setEditTahunAjaran(e.target.value)
                                            }>
                                            <option value="">-Pilih Tahun Ajaran-</option>
                                            {tahun_ajaran.map(({ id, nama }) => {
                                                
                                                if (siswa.id_tahun_ajaran == id){
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <input
                                            ...
                                            onChange={(e) =>
                                                setEditTanggalMasuk(e.target.value)
                                            }
                                        />
                                        <span className="text-red-600">
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <input
                                            ...
                                            name="no_induk"
                                            required
                                            value={editNomerInduk}
                                            onChange={(e) =>
                                                setEditNomerInduk(e.target.value)
                                            }
                                        />
                                        <span className="text-red-600">
                                            {errors.no_induk}
