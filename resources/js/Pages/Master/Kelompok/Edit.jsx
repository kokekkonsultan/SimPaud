...
export default function Edit({ auth, props, semester, kelompok_usia, guru }) {

    const { kelompok } = usePage().props;
    const { data, setData, put, errors } = useForm({
        id_semester: kelompok.id_semester || "",
        nama: kelompok.nama || "",
        id_kelompok_usia: kelompok.id_kelompok_usia || "",
        id_guru: kelompok.id_guru || "",
    });
    ...
    return (
        <DashboardLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Edit Kelompok</h2>}
        >
            <Head title="Kelompok" />
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 bg-white border-b border-gray-200">
                            ...
                            <h1 className="text-2xl mb-5">Edit Kelompok</h1>
                            ...
                            <form name="createForm" onSubmit={handleSubmit}>
                                ...
                                <div className="mb-4">
                                        ...
                                        <select name="id_semester" required className="w-full px-4 py-2" onChange={(e) =>
                                                setData("id_semester", e.target.value)
                                            }>
                                            <option value="">-Pilih Semester-</option>
                                            {semester.map(({ id, nama }) => {
                                                
                                                if (kelompok.id_semester == id){
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <select name="id_kelompok_usia" required className="w-full px-4 py-2" onChange={(e) =>
                                            ...
                                            {kelompok_usia.map(({ id, nama }) => {
                                                ...
                                                if (kelompok.id_kelompok_usia == id){
                                                    return <option value={id} selected>{nama}</option>
                                                }
